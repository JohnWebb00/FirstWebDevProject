<!-- This is just the HTML and CSS for Account Creation page. -->
...
<form action="action_page.php">
        <div class="container center">
          ...
          <p><b> Please enter your information below:</b></p>
            ...
            <input type="text" placeholder="Enter first and last name" name="FullName" id="FullName" required>
 <br>
 ...
 <br>
            ...
            <input type="text" placeholder="Enter postal code" name="PostNr" id="PostNr" required>
 <br>
            <label for="Address">Street address:</label>
            <input type="text" placeholder="Enter street name and number"Address" id="Address" required>
 <br>
            <p><b>By creating an account you agree to follow our <a href="#">Site Rules</a>.</p>
